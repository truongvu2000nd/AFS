...
"""
Adapt from the official repository of Designing an Encoder for StyleGAN Image Manipulation (https://arxiv.org/abs/2102.02766)
https://github.com/omertov/encoder4editing/blob/main/models/psp.py
"""
...
class pSp(nn.Module):
    ...
    def load_weights(self):
        ...
        msg = self.encoder.load_state_dict(get_keys(ckpt, 'encoder'), strict=True)
        print(msg)
